...
Bool StaticQueueEnqueue(StaticQueue *queue, int data)	//O(1)
{
...
Bool StaticQueueDequeue(StaticQueue *queue, int *data)	//O(1)
{
...
Bool StaticQueueFront(StaticQueue *queue, int *data)	//O(1)
{	
